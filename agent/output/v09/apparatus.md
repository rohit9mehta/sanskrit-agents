...
| samprayuktā | samprayukta | Stri. Prathama/Eka | pass |
| tathā | tathā | indecl. | pass |
| kleśaiḥ | kleśa | Pum. Trtiya/Bahu | pass |
| upakleśaiḥ | upakleśa | Pum. Trtiya/Bahu | pass |
| trivedanā | trivedana | Stri. Prathama/Eka; bahuvrihi ⟨tisraḥ vedanāḥ yasyāḥ sā⟩ | pass |
...
**J4. The printed verse has trivedanā as one word, and its feminine nominative singular form agrees predicatively with asau/saṃprayuktā. It is therefore not split as tri + vedanā, nor taken as an independent substantive “the three feelings.”**
- chosen: trivedanā is the feminine nominative singular of the bahuvrīhi adjective stem trivedana: “having three feelings” (depends on commentary: no)
...
- saṃprayuktā: treated here as a subanta past passive participial adjective from sam-pra-√yuj with verifier-normalized stem samprayukta, not as a finite verbal form; the printed saṃ- is retained in surface_in_sandhi.
- tri_vedanā: the analyzer split the printed trivedanā into tri + vedanā; here it is one compound, feminine nominative singular of the adjectival compound stem trivedana, used predicatively as a bahuvrīhi.
